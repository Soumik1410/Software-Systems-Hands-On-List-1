...
{
	char *env[]={NULL};
        execle("/bin/ls","/bin/ls","-Rl",NULL,env);
}
...
soumik@soumik-VirtualBox:~/SS_HandsOnList1$ cc 27c.c 
...
-rw-rw-r-- 1 soumik soumik   629 Aug 31 10:15 27c.c
...
-rwxrwxr-x 1 soumik soumik 16000 Aug 31 10:15 a.out
